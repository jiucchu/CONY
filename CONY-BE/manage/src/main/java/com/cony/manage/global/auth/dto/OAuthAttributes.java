package com.cony.manage.global.auth.dto;
...
public class OAuthAttributes {
    ...
    public OAuthAttributes(Map<String, Object> attributes, String nameAttributeKey,
                           String name, String email, String picture, String oauthId, OAuthProvider oauthProvider) {
    ...
    private static OAuthAttributes ofKakao(String userNameAttributeName, Map<String, Object> attributes) {
        ...
        return OAuthAttributes.builder()
                ...
                .picture(kakaoProfile != null ? (String) kakaoProfile.get("thumbnail_image_url") : null)
                .oauthId(String.valueOf(attributes.get(userNameAttributeName)))
